...
export function applyProxyToLinkResponse(body, { baseOrigin, proxy, streamHeaders }) {
  ...
  if (stormHls) {
    ...
    return {
      ...
      proxyMode: "client",
      playbackHint:
        "Open playerUrl in any browser for online playback. For VLC/MPV without command line, download downloadUrl and open the .m3u file. Plain url/qualityUrl will not work in most external players.",
    };
  }
